...
class InstrumentProvider:
    ...
    @staticmethod
    def equity(symbol: str, venue: str) -> Equity:
        return Equity(
    ...
    def synthetic_instrument() -> SyntheticInstrument:
        return SyntheticInstrument(
            symbol=Symbol("VTI-GLD.SYNTH"),
            price_precision=8,
            components=[
                InstrumentId(Symbol('GLD'), Venue('NYSE')),
                InstrumentId(Symbol('VTI'), Venue('NYSE')),
            ],
            formula="(VTI.NYSE/GLD.NYSE) * 100",
            ts_event=0,
            ts_init=0,
        )
